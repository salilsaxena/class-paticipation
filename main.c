...
/*
 *  .h files and and their functions:
 *  helper:
 *    length related fucntions.
 *  search :
 *    pos(H,ele,flag_all);
 *  insert_del: 
 ...
 *    insert_end(H,node_inp,ele) will only be used in init_end and init_front
 *    init_end(&H,&T);
 *    init_front(&H,&T);
 *  print:
 *    print_block(H)
 *    print_node(node_inp) not sure to insert it or not
 *
 *
 */
void main()
